                        ...
                        Switch(
                            ...
                            onCheckedChange = { enabled ->
                                if (enabled && smartImportAccount == null) {
                                    accountPickerLauncher.launch(GmailAuth.newChooseAccountIntent(context))
                                } else {
...
fun SettingsScreenPreview() {
    PackaTrackTheme(themeMode = "light") {
