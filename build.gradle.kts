...
buildscript {
    configurations.configureEach {
        resolutionStrategy {
            force(
                "org.apache.commons:commons-lang3:3.17.0", // GHSA-j288-q9x7-2f5v (uncontrolled recursion)
                "org.bitbucket.b_c:jose4j:0.9.6", // GHSA-3677-xxcr-wjqv (DoS via compressed JWE)
                "org.bouncycastle:bcpkix-jdk18on:1.80", // GHSA-wg6q-6289-32hp (broken crypto algorithm)
                "org.bouncycastle:bcprov-jdk18on:1.80", // GHSA-574f-3g2m-x479, GHSA-c3fc-8qff-9hwx
